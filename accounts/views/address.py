...
#         try:
#             if address_type and street_address and locality and landmark and city_id and pincode_id and country_id and company_id:
...
class CreateAddressAPIView(CreateAPIView):
    def post(self, request, *args, **kwargs):
        ...
        try:
            if all([address_type, street_address, locality, landmark, city_id, pincode_id, country_id, company_id]):
